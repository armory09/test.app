...
CREATE PROCEDURE CheckLeaveIdInclusiveDate(
	   @LeaveId AS int, @DateFrom AS datetime, @DateTo AS datetime)
AS
BEGIN
	...
	WHERE el.LeaveId = @LeaveId AND el.DateFiled BETWEEN @DateFrom AND @DateTo
END; 
GO